...
void loop() {
  ...
  switch (directionState) {
    ...
    case LEFT_TURN:
      ...
      //state business
      robot_commanded_heading = yaw + 10;
    ...
    case RIGHT_TURN:
      ...
      //state business
        robot_commanded_heading = yaw;
        adjustment = yaw - 10;
        robot_turns_to_heading(robot_commanded_heading,adjustment);
      //exit housekeeping
      robot_stop();
      delay(500);
      }
...
//================================================================
void robot_turns_to_heading(float yaw_heading, int adjustment) {
  if (yaw < (yaw_heading - adjustment)) {
    turn_counterclockwise(1 + 0.15 * ((yaw_heading + 2) - yaw));
  }
  else if (yaw > (yaw_heading + adjustment)) {
